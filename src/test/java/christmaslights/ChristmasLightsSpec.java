...
public class ChristmasLightsSpec {
    ...
    public void whenChristmasLightsInstantiatedThen0LightsOn(){
        assertEquals(0, lights.getNumberOfLightsTurnOn());
    }
    ...
    public void GivenOneTurnOfFollowbyInvalidBeginInstructWhenProcessInstrucThenRuntimeException(){
        instructions.add("turn off 0,0 through 999,999");
        instructions.add("qwoeqwiueqwe");
        expectedException.expect(RuntimeException.class);
        expectedException.expectMessage("Invalid instruction");
        lights.processInstructions(instructions);
    ...
    public void GivenFirstNumberFromFirstPairNegativeWhenProcessInstrucThenRuntimeException(){
        instructions.add("turn off -1,0 through 999,999");
        expectedException.expect(RuntimeException.class);
    ...
    public void GivenSecondNumberFromFirstPairNegativeWhenProcessInstrucThenRuntimeException(){
        instructions.add("turn off 0,-1 through 999,999");
        expectedException.expect(RuntimeException.class);
    ...
    public void GivenLetterInFirstPairNegativeWhenProcessInstrucThenRuntimeException(){
        instructions.add("turn off a,0 through 999,999");
        expectedException.expect(RuntimeException.class);
    ...
    public void GivenLetterInSecondPairNegativeWhenProcessInstrucThenRuntimeException(){
        instructions.add("turn off 0,0 through 999,a");
        expectedException.expect(RuntimeException.class);
    ...
    public void GivenInstructionWithoutThroughWhenProcessInstrucThenRuntimeException(){
        instructions.add("turn off 0,0 ssss 999,0");
        expectedException.expect(RuntimeException.class);
    ...
    @Test
    public void WhenTurnOnWholeColumnThen1000LightsOn(){
        instructions.add("turn on 0,0 through 999,0");
        lights.processInstructions(instructions);
        assertEquals(1000, lights.getNumberOfLightsTurnOn());
    }

    @Test
    public void whenTurnOn4RowAndColumnsSquareThen16LightsOn(){
        instructions.add("turn on 0,0 through 3,3");
        lights.processInstructions(instructions);
        assertEquals(16, lights.getNumberOfLightsTurnOn());
    }

    @Test
    public void WhenTurnOff4RowsAfterTurnOnAColumnThen996LightsOn(){
        instructions.add("turn on 0,0 through 999,0");
        instructions.add("turn off 0,0 through 3,0");
        lights.processInstructions(instructions);
        assertEquals(996, lights.getNumberOfLightsTurnOn());
    }

    @Test
    public void WhenTurnOff2SubSquareAfterTurnOnA4SquareThen996LightsOn(){
        instructions.add("turn on 0,0 through 3,3");
        instructions.add("turn off 0,0 through 1,1");
        lights.processInstructions(instructions);
        assertEquals(12, lights.getNumberOfLightsTurnOn());
    }

    @Test
    public void WhenTurnOn4SqueareTurnOff2SubSquareAndToggleWholeGridThen988LightsOn(){
        instructions.add("turn on 0,0 through 3,3");
        instructions.add("turn off 0,0 through 1,1");
        instructions.add("toggle 0,0 through 999,999");
        lights.processInstructions(instructions);
        assertEquals(999988, lights.getNumberOfLightsTurnOn());
    }

    @Test
    public void WhenMultiplesCommandsThenCorrectLightsOn(){
        String instructionsSequence = "turn off 660,55 through 986,197\n" +
        ...
        String[] instructions = instructionsSequence.split("\n");
        lights.processInstructions(Arrays.asList(instructions));
        assertEquals(400410, lights.getNumberOfLightsTurnOn());
    }
